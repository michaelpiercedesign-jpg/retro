...
export async function LoadUserAvatar(scene: BABYLON.Scene, parent: BABYLON.TransformNode, uuid: string, description: AvatarRecord): Promise<UserAvatar> {
...
export class UserAvatar extends Avatar {
  constructor(scene: BABYLON.Scene, parent: BABYLON.TransformNode, uuid: string, description: AvatarRecord) {
