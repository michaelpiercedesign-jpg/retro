...
import { pending } from '../../../web/src/helpers/scenes'
        ...
        {this.state.expandScale ? (
          <div>
            ...
            <div>
              ...
              <button onClick={() => this.setState({ expandScale: false })}>...</button>
            </div>
          </div>
        ) : (
          <div>
            ...
            <div>
              ...
              />
              <button onClick={() => this.setState({ expandScale: true })}>...</button>
            </div>
          </div>
        )}

        <div>
          <button onClick={pending(this.deleteAttachment)}>Remove</button>
        </div>
      </div>
    )
  }
